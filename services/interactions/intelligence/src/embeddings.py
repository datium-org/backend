...
<<<<<<< HEAD:services/interactions/intelligence/src/embeddings.py
import intelligence.src.utils.paths as paths
=======
import intelligence_service.src.utils.paths as paths
>>>>>>> db:interactions/intelligence_service/src/embeddings.py
