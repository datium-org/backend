from db.router.router import router as db_router
from intelligence.router.router import router as intelligence_router
...
app.include_router(db_router, prefix="/api/interactions/db")
app.include_router(intelligence_router, prefix="/api/interactions/intelligence")
